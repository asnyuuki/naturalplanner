...
<section class="header text-start">
    <div class="d-flex justify-content-between">
        <img src="/assets/img/background/flower.svg" width="280" style="margin-left: -50px; margin-top: 20px; opacity: .4;">
        <div class="deskripsi">
        ...
        <div class="d-block col-4" style="background-image: url('/assets/img/background/ring.svg'); background-repeat: no-repeat; background-size: cover">
            <div class="card bg-transparent border-0" style="width: 95%; transform: rotate(-6deg) translateX(-10px)">
                <img src="/assets/img/foto/polaroid.png">
            </div>
        </div>
    </div>
</section>
